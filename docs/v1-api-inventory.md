...
- type: `type DriverType string`
- type: `type Idempotency interface{Close() error; Consume(ctx context.Context, key string, ttl time.Duration, fn func(ctx context.Context) error) (executed bool, err error); Execute(ctx context.Context, key string, fn func(ctx context.Context) (any, error)) (any, error); GinMiddleware(opts ...MiddlewareOption) any; UnaryServerInterceptor(opts ...InterceptorOption) grpc.UnaryServerInterceptor}`
