...
- type: `type Locker interface{Close() error; Lock(ctx context.Context, key string, opts ...LockOption) error; TryLock(ctx context.Context, key string, opts ...LockOption) (bool, error); Unlock(ctx context.Context, key string) error}`
- type: `type Option func(*options)`
- var: `var ErrClosed`
...
- func: `func ParseGeneratorID(id int64, mode GeneratorMode) (timestamp int64, datacenterID int64, workerID int64, sequence int64)`
